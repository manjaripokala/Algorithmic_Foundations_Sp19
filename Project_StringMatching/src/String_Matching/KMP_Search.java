...
public class KMP_Search {
	    ...
	    public  static void main(String[] args) {
			...
			textList = Read_Text.data_multiply(textList, 1000, 3000000);
	        ...
	        for(Text e : textList) {
	        	for(Pattern p : patternList) {
	        		...
	        		KMP.KMP_search(e.gettext(), p.getpattern());
	         
	                //Out.Write(e.gettext(), p.getpattern(), KMP.KMP_search(e.gettext(), p.getpattern()));
	            	}
	            }
